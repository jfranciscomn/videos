...
class Estatus extends CActiveRecord
{
	...
	public function relations()
	{
		...
		return array(
			'proyecto' => array(self::HAS_ONE, 'Proyecto', 'estatus_id'),
			'usuario' => array(self::HAS_ONE, 'Usuario', 'estatus_id'),
			'video' => array(self::HAS_ONE, 'Video', 'estatus_id'),
			'videosPorProyecto' => array(self::HAS_ONE, 'VideosPorProyecto', 'estatus_id'),
		);
	}
